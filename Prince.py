 ...
 | |____| |_) | (_| |
  \_____| .__/ \__,_|
        ...
        |_|          
         ...
         \033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS PRÍNCE ON FIRE \033[;0m\033[1;91m═══>\033[1;92m
         \033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS PRÍNCE LÜCKY ON FIRE\033[;0m\033[1;91m═══>\033[1;92m
\033[1;31m==================================================
[] AUTHOR       :     PRÍNCE LÜCKY
[] TOOLS        :     𝐅𝐈𝐋𝐄-𝐂𝐋𝐎𝐍𝐈𝐍𝐆
[] TYPE         :       𝐅 𝐑 𝐄 𝐄
...
def main():
    logox()
    print("  [A] FILE CLONE  |   [ RANDOM CLONE   |   [C] EXIT TOOL")
    print(cox)
    want=input("  [✓] INPUT+>")
    if want in ["A","a","1","01"]:
        file_iclone()
